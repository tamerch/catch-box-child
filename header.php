...
<div id="page" class="hfeed">
	...
	<header id="branding" role="banner">
			<?php //do_action( 'catchbox_site_generator' ); ?>
			<hgroup>
			...
			<div id="loginout">
				<?php 
					//wp_loginout();
					/** login logout -> see wp-includes/general-template.php */
			        if ( ! is_user_logged_in() )
			                $link = '<a href="' . esc_url( wp_login_url() ) . '">' . __('Log in') . '<img src="'.get_stylesheet_directory_uri().'/images/connection-off.png" alt=""></a>';
			        else
			                $link = '<a href="' . esc_url( wp_logout_url() ) . '">' . __('Log out') . '<img src="'.get_stylesheet_directory_uri().'/images/connection-on.png" alt=""></a>';
